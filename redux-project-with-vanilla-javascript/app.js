...
window.onload = () => {
     ...
     *  Tuyauterie
     **/
    const init = () => dispatchActionToStore(listTodoAction());

    const dispatchActionToStore = (action) => {
    ...
    const updateView = () => {
        ...
        document.querySelector('#todo-list').innerHTML = state.todos.map((todo, index) =>
            `
                <tr>
